define([
    ...
    methods.loadHeader = function (args) {
                ...
                <div class="navbar-collapse collapse" id="ftco-nav2">
                    <ul class="navbar-nav m-auto">
                        <li class="nav-item my-selected-item"><a href="index.html" class="nav-link">Home</a></li>
                        <li class="nav-item dropdown active" id="dropmenu">
                    <a class="nav-link" href="service.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Services</a>
                    
                    </li>
                        
                        
                    <li class="nav-item"><a href="hireus.html" class="nav-link">Hire Us</a></li>
                    </ul>
                </div>
                </div>
            </nav>
